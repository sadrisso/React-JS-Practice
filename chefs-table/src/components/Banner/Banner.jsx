...
const Banner = () =>
{
    ...
    return (
        <div className="bg-cover bg-no-repeat bg-center rounded-3xl md:w-full h-full md:h-[35.5rem] m-5 mx-auto " style= {{backgroundImage: 'url(https://i.ibb.co.com/1zqDFxF/chef-1.jpg)'}}>
